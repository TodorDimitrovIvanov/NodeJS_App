    ...
    bm.add('b1-2', {
        ...
        content: `
          <div class="row-flex" data-columns="1" style="text-align: center" data-gjs-droppable="[data-column]" data-gjs-highlightable="false" data-gjs-resizable='{"tl":0,"tc":0,"tr":0,"cl":0,"cr":0,"bl":0,"br":0}' data-gjs-custom-name="Row">
            <div class="cell-flex col1" data-column="1" style="letter-spacing: normal; flex-basis: 1000px" data-gjs-draggable="[data-columns]" data-gjs-resizable='{"tl":0,"tc":0,"tr":0,"cl":0,"bl":0,"br":0,"bc": 0, "keyWidth": "flex-basis", "currentUnit": 1}' data-gjs-unstylable='["width"]' data-gjs-stylable-require='["flex-basis"]'></div>
            <div class="cell-flex col2" data-column="1" style="letter-spacing: normal; flex-basis: 1000px" data-gjs-draggable="[data-columns]" data-gjs-resizable='{"tl":0,"tc":0,"tr":0,"cl":0,"bl":0,"br":0,"bc": 0, "keyWidth": "flex-basis", "currentUnit": 1}' data-gjs-unstylable='["width"]' data-gjs-stylable-require='["flex-basis"]'></div>
          </div>
          <style>
            .row-flex {
                display: flex;
    ...
    */
    ...
    domc.addType('image-container', {
      ...
      },
      {
        ...
        {
          if(el.tagName == 'DIV' && grapesjs.$(el).hasClass("image-container"))
          {
    ...
    bm.add('image-container', {
      label: 'Image Container',
      attributes: {class:'fa fa-pencil'},
      content: '<DIV class="image-container" style="padding:20px"></DIV>',
      category: 'Basic',
    });
    editor.on('component:drag-start', (src, srcModel) => {
      console.log('Drag start', src, srcModel);
    });
    editor.on('component:drag', (params) => {
      console.log('Drag', params);
    });
    editor.on('component:drag-validation', (validation) => {
      console.log('Drag validation', validation);
    });
    editor.on('component:dragEnd:before', (dst, src, pos) => {
      console.log('Drag before end', dst, src, pos);
    });*/

    // Keymaps
    /*
    editor.Keymaps.add('core:test1', 'a', () => console.log('inside core:test1'))
    editor.Keymaps.add('core:test2', 'b', () => console.log('inside core:test2'))
    editor.Keymaps.add('core:test3', 'c', 'open-assets')
    editor.on('keymap:emit', (id, shortcut, event) => {
      console.log('EMITTED ', id, 'shortcut used:', shortcut);
    });
    */
